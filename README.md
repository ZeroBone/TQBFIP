...
command. Here, `-pql` stands for **p**lay in **q**uality **l**ow. If you don't want the animation to be played after rendering is complete, remove **p**. The rendering quality can be also changed from **l**ow to **m**edium or **h**igh. For more information regarding the commands available, see the [Manim documentation](https://docs.manim.community/en/stable/).
